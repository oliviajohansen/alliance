...
import { BuddyUpCountryData } from "../data";

const Buddy_up_country = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Your origin matched with:</Text>
      <FlatList
        data={BuddyUpCountryData.filter((b) => b.id < 4)}
...
export default Buddy_up_country;
